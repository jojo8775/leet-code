 ...
 * Example 1:
 * 
 * Input: ["abcd","cdab","cbad","xyzz","zzxy","zzyx"] Output: 3 Explanation: One
 ...
 * particular, "zzxy" is not special equivalent to "zzyx". Example 2:
 * 
 ...
 * All A[i] consist of only lowercase letters. Accepted 35,465 Submissions
 * 50,951
 * 
 * @author jojo Apr 15, 2021 10:48:37 PM
 */
public class GroupsOfSpecialEquivalentStrings {
	public int numSpecialEquivGroups(String[] A) {
		...
		for (String w : A) {
			...
			// since we can move only even index with even index and odd index with odd
			// index, need to create a map
			...
			String str = Arrays.toString(even) + "-" + Arrays.toString(odd);
			group.add(str);
		}
