...
amazon
 * @author jojo
 * Aug 3, 2020  3:40:00 PM
 */
public class AmazonFresh {
	public int findPrize(String[][] codeList, String[] shoppingList) {
		...
		for(int i=0, j=0, k=0; k<shoppingList.length; k++) {
			if(codeList[i][j].equals(shoppingList[k]) || codeList[i][j].equals("anything")) {
				j++;
