 ...
 * c = 5 such that (a OR b == c) Example 2:
 * 
 ...
 * Constraints:
 * 
 * 1 <= a <= 10^9 1 <= b <= 10^9 1 <= c <= 10^9 Accepted 86,697 Submissions
 * 121,040
 * 
 * @author jojo Jun. 8, 2023 12:29:17 a.m.
 */
public class MinimumFlipToMakeAorBEqualToC {
