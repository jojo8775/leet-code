...
35,069
 * @author jojo
 * Oct 16, 2022 10:25:18 PM
 */
public class FindGoodDaysToRobTheBank {
	public List<Integer> goodDaysToRobBank(int[] security, int time) {
        int len = security.length;
        
        int[] increasingArr = new int[len], decreasingArr = new int[len];
        
        for(int i=1; i < len - time; i++){
            ...
            // System.out.print("dec:[" + i + "]=" + decreasingArr[i] + ", ");
        }
        ...
        for(int i=len - 2; i >= time; i--){
            ...
            // System.out.print("inc:[" + i + "]=" + increasingArr[i] + ", ");
        }
