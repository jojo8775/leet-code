...
149,814
 * @author jojo
 * Mar. 26, 2024 9:49:57 p.m.
 */
public class MinimumPenaltyForAShop {
	public int bestClosingTime(String customers) {
        int len = customers.length();

        int closingTime = len, cur = 0;

        // this is similar to kandan's algo ---> just the reverse way.
        for(int i=len-1; i>=0; i--){
            ...
            // if the penalty making the gain to zero then all of right side is useless.
            if(cur <= 0){
                cur = 0;
                closingTime = i;
            }
	...
	public int bestClosingTime_1(String customers) {
