 ...
 * Constraints:
 * 
 * 2 <= letters.length <= 104 letters[i] is a lowercase English letter. letters
 * is sorted in non-decreasing order. letters contains at least two different
 * characters. target is a lowercase English letter. Accepted 327,780
 * Submissions 684,153
 * 
 * @author jojo Jun. 8, 2023 11:43:23 p.m.
 */
